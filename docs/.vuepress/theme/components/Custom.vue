<template>
  <div class="container">
    ...
    <div class="head-social">
      <a href="https://github.com/yunfenglong" target="_blank" class="head-social-btn">
        <icon name="grommet-icons:github" />
      </a>
      <router-link to="/blog/" class="head-social-avatar"><img src="/avatar.jpeg" alt="avatar"></router-link>
      <a href="mailto:yunfeng.long@yahoo.com" target="_blank" class="head-social-btn">
    ...
    <div class="about-me">
      ...
      <div class="card-content grid-row-1-1">
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              <p class="about-me-card-title-normal">Goal</p>
              <p class="about-me-card-text-big about-me-card-text-soft">To <span style="color: #3a5ccc">create</span>
              </p>
              <p class="about-me-card-text-big">Be <span style="color: #d53737">inspired</span></p>
            </slot>
          </template>
        </AboutMeText>
        <AboutMeCharacter />
