  ...
  <div class="about-me-card-bg vp-blog-post-item about-me-character">
    ...
    <div class="about-me-character-content">
      <div class="about-me-character-type">
        <p class="about-me-card-text-big about-me-card-text-color">Logistician</p>
        <p class="about-me-card-text-big">ISTJ-A</p>
      </div>
...
.about-me-character-img {
  ...
  width: fit-content;
  min-height: 110px;
  background-image: url("https://www.16personalities.com/static/images/personality-types/avatars/email/large/ISTJ_male.png?v=1");
