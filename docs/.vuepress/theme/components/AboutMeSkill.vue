<template>
  <div class="about-me-card-bg vp-blog-post-item about-me-skill">
    <div style="margin-left: 20px">
      <p class="about-me-card-title-normal">Skills</p>
      <p class="about-me-card-text-big">My abilities</p>
    </div>
...
const technology = ref([
  ...
  {type: 'Ant Design', icon: 'logos:ant-design'}
]);
...
const tools = ref([
  ...
  {type: 'Postman', icon: 'logos:postman'},
