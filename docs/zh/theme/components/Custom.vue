    ...
    <div class="about-me">
      ...
      <div class="card-content grid-row-1-1">
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              <p class="about-me-card-title-normal">目标</p>
              <p class="about-me-card-text-big about-me-card-text-soft">感受 <span style="color: #3a5ccc">生活</span>
              </p>
              <p class="about-me-card-text-big">热爱 <span style="color: #d53737">创造</span></p>
            </slot>
          </template>
        </AboutMeText>
        <AboutMeCharacter />
