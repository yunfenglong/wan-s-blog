<script setup>
import FRIENDS from '../../../.vuepress/theme/data/friends.json'
</script>

<template>
  <div class="about-me-card-bg vp-blog-post-item about-me-friends">
    <p class="about-me-card-title-normal">連結</p>
    <div class="about-me-friends-title">
      <p class="about-me-card-text-big about-me-card-text-color">我嘅朋友</p>
      <router-link to="/zh-TW/more/friends/">
